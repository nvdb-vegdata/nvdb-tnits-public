...
class JtsGeometrySerializerTest : ShouldSpec({
    ...
    should("serialize and deserialize LineString geometry") {
        ...
        originalLineString.srid = SRID.UTM33
    ...
    should("handle empty geometries") {
        ...
        emptyLineString.srid = SRID.UTM33
    ...
    should("handle geometries with Z coordinates") {
        ...
        val originalLineString = geometryFactory.createLineString(coordinatesWithZ).also { it.srid = SRID.UTM33 }
    ...
    should("handle complex road network geometries") {
        ...
        // Verify coordinate precision is preserved (Configured geometry factory preserves coordinates to 1 decimal place)
