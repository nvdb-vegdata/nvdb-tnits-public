...
public class DatoEgenskap extends EgenskapVerdi {
  ...
  public DatoEgenskap verdi(@jakarta.annotation.Nonnull LocalDate verdi) {
  ...
  @JsonProperty(JSON_PROPERTY_VERDI)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setVerdi(@jakarta.annotation.Nonnull LocalDate verdi) {
    this.verdi = verdi;
  }


  @Override
  public DatoEgenskap type(@jakarta.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }
