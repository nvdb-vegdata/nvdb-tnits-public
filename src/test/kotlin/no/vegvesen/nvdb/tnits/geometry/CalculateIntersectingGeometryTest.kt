...
class CalculateIntersectingGeometryTest :
    StringSpec({
        ...
        "returns null when utstrekning objects do not overlap" {
            ...
            val veglenkeUtstrekning = Utstrekning(1L, 0.0, 0.5)
            val stedfestingUtstrekning = Utstrekning(1L, 0.7, 1.0)
        ...
        "returns full geometry when utstrekning objects are identical" {
            ...
            val veglenkeUtstrekning = Utstrekning(1L, 0.0, 1.0)
            val stedfestingUtstrekning = Utstrekning(1L, 0.0, 1.0)
        ...
        "extracts first half of geometry when intersection covers first 50%" {
            ...
            val veglenkeUtstrekning = Utstrekning(1L, 0.0, 1.0)
            val stedfestingUtstrekning = Utstrekning(1L, 0.0, 0.5)
        ...
        "extracts middle section of geometry when intersection is in the middle" {
            ...
            val veglenkeUtstrekning = Utstrekning(1L, 0.0, 1.0)
            val stedfestingUtstrekning = Utstrekning(1L, 0.25, 0.75)
        ...
        "handles subset intersection within partial veglenke" {
            ...
            val veglenkeUtstrekning = Utstrekning(1L, 0.1, 0.9)
            val stedfestingUtstrekning = Utstrekning(1L, 0.2, 0.8)
        ...
        "returns null when different veglenkesekvensId" {
            ...
            val geometry = parseWkt(wkt, SRID.UTM33)
            val veglenkeUtstrekning = Utstrekning(1L, 0.0, 1.0)
            val stedfestingUtstrekning = Utstrekning(2L, 0.0, 0.5)
        ...
        "handles single point intersections" {
            ...
            val geometry = parseWkt(wkt, SRID.UTM33)
            val veglenkeUtstrekning = Utstrekning(1L, 0.0, 1.0)
            val stedfestingUtstrekning = Utstrekning(1L, 0.5, 0.5)
        ...
        "handles partial overlap" {
            ...
            val geometry = parseWkt(wkt, SRID.UTM33)
            val veglenkeUtstrekning = Utstrekning(1L, 0.5, 0.9)
            val stedfestingUtstrekning = Utstrekning(1L, 0.6, 1.0)
            ...
            result.utstrekning shouldBe Utstrekning(1L, 0.6, 0.9)
        }

        "handles stedfesting that extends beyond veglenke" {
            val wkt = "LINESTRING (500000 6600000, 500100 6600000, 500200 6600000)"
            val geometry = parseWkt(wkt, SRID.UTM33)
            val veglenkeUtstrekning = Utstrekning(1L, 0.3, 0.7)
            val stedfestingUtstrekning = Utstrekning(1L, 0.0, 1.0)
            val utstrekningGeometri = UtstrekningGeometri(veglenkeUtstrekning, geometry)
