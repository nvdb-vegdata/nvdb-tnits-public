...
suspend fun backfillVegobjekter(typeId: Int) {
    ...
    do {
        ...
        if (vegobjekter.isEmpty()) {
            ...
            transaction {
//                insertVegobjekterRocksDb(vegobjekter)
//                insertVegobjekterSql(vegobjekter)
...
context(vegobjekterRepository: VegobjekterRepository)
private fun insertVegobjekterRocksDb(vegobjekter: List<Vegobjekt>) {
