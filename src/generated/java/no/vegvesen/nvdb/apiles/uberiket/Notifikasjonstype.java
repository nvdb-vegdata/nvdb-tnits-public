...
/**
 * Gets or Sets Notifikasjonstype
 */
public enum Notifikasjonstype {
  ...
  Notifikasjonstype(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static Notifikasjonstype fromValue(String value) {
    for (Notifikasjonstype b : Notifikasjonstype.values()) {
